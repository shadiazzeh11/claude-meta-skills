...
Release target: **`v0.1.3` technical preview**.
Previous published release: **`v0.1.2` technical preview**.
...
VERSION=v0.1.3  # replace with the target release version
...
- `make test-stop-env` passes `89/89`
...
- 89/89 synthetic harness validation tests.
